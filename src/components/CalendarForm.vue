...
<template>
    <div class="calendarLayout">
        ...
        <s-button v-if="!endDateVisible.valueOf()" label="+ data final" class="add-btn" @click="()=>{endDateVisible=true}"/>
    </div>
    <div class="calendarLayout" v-if="endDateVisible.valueOf()">
        ...
        <el-button id="cancel" @click="closeCalendar"><el-icon><Close /></el-icon></el-button>
    </div>
</template>
<style scoped>
